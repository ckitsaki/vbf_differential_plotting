...
inline std::string xAxisTitle(std::string observable)
{
  ...
  if(observable == "jet0_pt") title = "#it{p}_{T}^{j_{1}} [GeV]";
  if(observable == "jet1_pt") title = "#it{p}_{T}^{j_{2}} [GeV]";
  ...
  if(observable == "Ml0j0") title = "#it{m}_{l_{1}j_{1}} [GeV]";
  if(observable == "jet0_eta") title = "#it{#eta}^{j_{1}}";
  if(observable == "jet1_eta") title = "#it{#eta}^{j_{2}}";
  if(observable == "nJets") title = "n_{jet}";
  if(observable == "lep0_pt") title = "#it{p}_{T}^{l_{1}} [GeV]";
  if(observable == "lep1_pt") title = "#it{p}_{T}^{l_{2}} [GeV]";
  if(observable == "lep0_eta") title = "#it{#eta}^{l_{1}}";
  if(observable == "lep1_eta") title = "#it{#eta}^{l_{2}}";
