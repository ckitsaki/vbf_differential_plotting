...
{
  std::string title;
  if(observable == "Mjj") title = "#it{m}_{jj} [GeV]";
  if(observable == "Mll") title = "#it{m}_{ll} [GeV]";
  if(observable == "mtt") title = "#it{m}_{tt} [GeV]";
  if(observable == "DYjj") title = "#it{#Deltay}_{jj}";
  if(observable == "DYll") title = "#it{#Deltay}_{ll}";
  if(observable == "jet0_pt") title = "#it{p}_{T}^{jet_{0}} [GeV]";
  if(observable == "jet1_pt") title = "#it{p}_{T}^{jet_{1}} [GeV]";
  ...
  if(observable == "costhetastar") title = "|#it{cos#theta}^{*}|";
  if(observable == "ptTot") title = "#it{p}_{T}^{Tot} [GeV]";
  if(observable == "pt_H") title = "#it{p}_{T}^{H} [GeV]";
  if(observable == "sumOfCentralitiesL") title = "#sum_{l}#it{C}_{l}";
  if(observable == "SignedDPhijj") title = "#it{#Delta#phi}_{jj}";
  if(observable == "DPhijj") title = "|#it{#Delta#phi}_{jj}|";
  if(observable == "DPhill") title = "#it{#Delta#phi}_{ll} [rad]";
  if(observable == "MT") title = "#it{m}_{T} [GeV]";
  if(observable == "MET") title = "#it{E}_{T}^{miss} [GeV]";
  ...
  if(observable == "Ml0j0") title = "#it{m}_{l_{0}j_{0}} [GeV]";
  if(observable == "jet0_eta") title = "#it{#eta}^{jet_{0}}";
  if(observable == "jet1_eta") title = "#it{#eta}^{jet_{1}}";
  if(observable == "nJets") title = "n_{jet}";
  if(observable == "lep0_pt") title = "#it{p}_{T}^{lep_{0}} [GeV]";
  if(observable == "lep1_pt") title = "#it{p}_{T}^{lep_{1}} [GeV]";
  if(observable == "lep0_eta") title = "#it{#eta}^{lep_{0}}";
  if(observable == "lep1_eta") title = "#it{#eta}^{lep_{1}}";
