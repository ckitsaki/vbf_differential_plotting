...
void post_fit(std::string input="Mjj", int Nbins_SR1=5, int Nbins_SR2=5, bool doScale=false)
{
  ...
  h_ggf_DYCR->SetFillColor(kOrange+3);
  ...
  h_ggf_CRGGF->SetFillColor(kOrange+3);
  ...
  for(int ibin_SR1 = 0; ibin_SR1<Nbins_SR1; ibin_SR1++)
  {
  	...
  	double total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
    v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(0, std::abs( total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(22)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(0, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(3)));
  	ibin =1;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(1, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(20)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(1, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(5)));
  	ibin = 2;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(2, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(18)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(2, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(7)));
  	ibin = 3;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(3, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(16)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(3, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(9)));
  	}
  	else {
  	double total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
    v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(0, std::abs( total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(26)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(0, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(3)));
  	ibin =1;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(1, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(24)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(1, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(5)));
  	ibin = 2;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(2, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(22)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(2, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(7)));
  	ibin = 3;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(3, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(20)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(3, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(9)));
    ibin = 4;
  	total_mc = v_h_Zjets_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vh_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_htt_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_vbf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_top_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_diboson_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_ggf_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Fakes_SR1.at(ibin_SR1)->GetBinContent(ibin+1)+v_h_Vgamma_SR1.at(ibin_SR1)->GetBinContent(ibin+1); 
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYlow(4, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(18)));
  	v_h_sysErr_SR1.at(ibin_SR1)->SetPointEYhigh(4, std::abs(total_mc-v_rc_sysErrorPdf_SR1.at(ibin_SR1)->GetPointY(11)));
  	}
  	...
  	v_h_ggf_SR1.at(ibin_SR1)->SetFillColor(kOrange+3);
  ...
  for(int ibin=0; ibin<totalBins; ibin++)
  {
    ...
    if(binSR1>3){
      ...
      if(doScale) {
      	...
      	if(input=="Mjj") {
        if(ibin<8) scale=4;
        else if(ibin>7 && ibin<12) scale = 6;
        else if(ibin>11 ) scale = 8;
        else scale=1;
       ...
       // if(ibin>7 && ibin<12) scale = 2;
      	if(ibin>11) scale = 4;
      	else if( (ibin<12 && ibin>7) || ibin<4 ) scale =2;
      	else scale = 1;
      ...
      h_sys_all_SR1->SetPointY(ibin, scale*v_h_sysErr_SR1.at(next)->GetPointY(binSR1));
  ...
  h_ggf_all_SR1->SetFillColor(kOrange+3);
  ...
  for(int ibin_SR2 = 0; ibin_SR2<Nbins_SR2; ibin_SR2++)
  {
	...
	if(input=="SignedDPhijj") {
  	...
  	v_h_ggf_SR2.at(ibin_SR2)->SetFillColor(kOrange+3);
  ...
  h_vbf_all_SR2->Sumw2();
  h_zjets_all_SR2->Sumw2();

  h_top_all_SR2->Sumw2();
  h_diboson_all_SR2->Sumw2();
  h_ggf_all_SR2->Sumw2();
  h_fakes_all_SR2->Sumw2();
  ...
  h_ggf_all_SR2->SetFillColor(kOrange+3);
...
// Draw everything on canvas
  ...
  padsr1->SetTopMargin(0.15);
  padsr1->SetBottomMargin(0.025);
  padsr1->SetRightMargin(0.1);
  padsr1->SetLeftMargin(0.1);
  padsr1->Draw();
  padsr1->cd();

  // gPad->SetLogy();
  h_stack_SR1_all->Draw("hist");
  h_stack_SR1_all->SetMaximum(60);
  if(input=="DYjj") h_stack_SR1_all->SetMaximum(70);
  if(input=="Mll") h_stack_SR1_all->SetMaximum(110);
  if(input=="jet0_pt" || input=="jet1_pt" ) h_stack_SR1_all->SetMaximum(120);
  if(input=="lep1_pt" ) h_stack_SR1_all->SetMaximum(100);
  if(input=="DYll" || input=="Ptll") h_stack_SR1_all->SetMaximum(90);
  if(input=="DPhill" ) h_stack_SR1_all->SetMaximum(50);
  if(input=="Mjj") h_stack_SR1_all->SetMaximum(135);
  if(input=="lep0_pt") h_stack_SR1_all->SetMaximum(45);

  h_stack_SR1_all->GetYaxis()->SetTitle("Events");
  h_stack_SR1_all->GetYaxis()->SetTitleOffset(0.95);
  h_stack_SR1_all->GetXaxis()->SetLabelOffset(10);
   h_stack_SR1_all->GetYaxis()->SetLabelOffset(.01);
  ...
  double mult = 12;
  double subtract = 2;
  if( input=="DYjj" || input=="SignedDPhijj") {mult = 6; subtract=-2;}
  if( input=="DYll" ) { mult = 8; subtract = -1;}
  if(input == "costhetastar" || input=="DPhill" || input=="pt_H" ) { mult = 5; subtract = -1;}
  if(input == "lep0_pt" ){ mult =4; subtract =-1;}
  TLine* line0 = new TLine(1., 0., 1., gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - 3. );
  TLine* line1 = new TLine(1.5, 0., 1.5, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - 3. );
  TLine* line2 = new TLine(2., 0., 2., gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - 3. );
  TLine* line3 = new TLine(2.5, 0., 2.5, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - 3. );
  line0->Draw("same");
  line1->Draw("same");
  line2->Draw("same");
  line3->Draw("same");
  ...
  if(input=="lep1_pt" || input=="jet0_pt" || input=="jet1_pt" || input=="pt_H" || input=="Mll" || input=="Ptll") mytext.DrawLatex(1.5, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax(), subtit.c_str());
  else mytext.DrawLatex(1.6, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax(), subtit.c_str());
  ...
  if(isScale){
   if(input=="Mjj") mytext.DrawLatex(.75,101,"x1");
   if(input=="DYll") mytext.DrawLatex(.75,65,"x1");
   if(input=="lep1_pt") mytext.DrawLatex(.75,73,"x1");
   if(input=="jet0_pt") mytext.DrawLatex(.75,90,"x1");
   if(input=="jet1_pt") mytext.DrawLatex(.75,90,"x1");
   if(input=="pt_H") mytext.DrawLatex(.75,45,"x1");
   if(input=="Ptll") mytext.DrawLatex(.75,63,"x2");
   if(input=="Mll") mytext.DrawLatex(.75,83,"x1");
   if(input=="costhetastar") mytext.DrawLatex(.75,45,"x2");
   if(input=="lep0_pt") mytext.DrawLatex(.75,33,"x1");
   if(input=="DYjj") mytext.DrawLatex(.75,50,"x1");
  }
  subtit=obs_title(input) + " Bin2";
  xstart = 1.15;
  if(input=="costhetastar"  ) xstart = 1.05;
  if(input=="lep0_pt" || input=="DPhill" || input=="DYll" || input=="DYjj") xstart = 1.1;
  mytext.DrawLatex(xstart,gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract) ,subtit.c_str());
  if(isScale) {
    if(input=="Mjj") mytext.DrawLatex(1.25,101,"x4");
    if(input=="DYll") mytext.DrawLatex(1.25,65,"x2");
    if(input=="lep1_pt") mytext.DrawLatex(1.25,73,"x2");
    if(input=="jet0_pt") mytext.DrawLatex(1.25,90,"x4");
    if(input=="jet1_pt") mytext.DrawLatex(1.25,90,"x2");
    if(input=="pt_H") mytext.DrawLatex(1.25,45,"x1");
    if(input=="Ptll") mytext.DrawLatex(1.25,63,"x1");
    if(input=="Mll") mytext.DrawLatex(1.25,83,"x2");
    if(input=="costhetastar") mytext.DrawLatex(1.25,45,"x2");
    if(input=="lep0_pt") mytext.DrawLatex(1.25,33,"x1");
    if(input=="DYjj") mytext.DrawLatex(1.25,50,"x1");
  }
  subtit=obs_title(input) + " Bin3";
  xstart = 1.65;
  if(input=="costhetastar" || input=="DYll") xstart = 1.55;
  if(input=="lep0_pt" || input=="DPhill" || input=="DYjj") xstart = 1.6;
  mytext.DrawLatex(xstart,gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract) ,subtit.c_str());
  if(isScale) {
    if(input=="Mjj") mytext.DrawLatex(1.75,101,"x6");
    if(input=="DYll")  mytext.DrawLatex(1.75,65,"x2");
    if(input=="lep1_pt")  mytext.DrawLatex(1.75,73,"x4");
    if(input=="jet0_pt")  mytext.DrawLatex(1.75,90,"x4");
    if(input=="jet1_pt")  mytext.DrawLatex(1.75,90,"x6");
    if(input=="pt_H")  mytext.DrawLatex(1.75,45,"x1");
    if(input=="Ptll")  mytext.DrawLatex(1.75,63,"x2");
    if(input=="Mll")  mytext.DrawLatex(1.75,83,"x2");
    if(input=="costhetastar")  mytext.DrawLatex(1.75,45,"x2");
    if(input=="lep0_pt")  mytext.DrawLatex(1.75,33,"x1");
    if(input=="DYjj")  mytext.DrawLatex(1.75,50,"x2");
  }
  subtit=obs_title(input) + " Bin4";
  xstart = 2.15;
  if(input=="costhetastar") xstart = 2.05;
  if(input=="lep0_pt" || input=="DPhill" ||  input=="DYll" || input=="DYjj") xstart = 2.1;
  mytext.DrawLatex(xstart,gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract) ,subtit.c_str());
  if(isScale) {
   if(input=="Mjj") mytext.DrawLatex(2.25,101,"x8");
   if(input=="DYll") mytext.DrawLatex(2.25,65,"x4");
   if(input=="lep1_pt") mytext.DrawLatex(2.25,73,"x4");
   if(input=="jet0_pt") mytext.DrawLatex(2.25,90,"x4");
   if(input=="jet1_pt") mytext.DrawLatex(2.25,90,"x6");
   if(input=="pt_H") mytext.DrawLatex(2.25,45,"x4");
   if(input=="Ptll") mytext.DrawLatex(2.25,63,"x4");
   if(input=="Mll") mytext.DrawLatex(2.25,83,"x2");
   if(input=="costhetastar") mytext.DrawLatex(2.25,45,"x1");
   if(input=="lep0_pt") mytext.DrawLatex(2.25,33,"x1");
   if(input=="DYjj") mytext.DrawLatex(2.25,50,"x2");
 }
  subtit=obs_title(input) + " Bin5";
  xstart=2.65;
  if(input=="costhetastar" ) xstart = 2.53;
  if(input=="lep0_pt" || input=="DPhill" ||  input=="DYll" || input=="DYjj") xstart = 2.6;
  mytext.DrawLatex(xstart,gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract) ,subtit.c_str());
  if(isScale) {
    if(input=="Mjj") mytext.DrawLatex(2.75,101,"x8");
    if(input=="DYll") mytext.DrawLatex(2.75,65,"x1");
    if(input=="lep1_pt") mytext.DrawLatex(2.75,73,"x4");
    if(input=="costhetastar") mytext.DrawLatex(2.75,45,"x1");
    if(input=="lep0_pt") mytext.DrawLatex(2.75,33,"x2");
    if(input=="DYjj") mytext.DrawLatex(2.75,50,"x1");
  }
  ...
  h_ratio_SR1_all->GetYaxis()->SetLabelSize(.1);

  h_ratio_SR1_all->GetYaxis()->SetLabelOffset(.015);

  h_ratio_SR1_all->GetYaxis()->SetNdivisions(505);
  h_ratio_SR1_all->GetYaxis()->CenterTitle(true);
  h_ratio_SR1_all->GetYaxis()->SetTitleOffset(.45);
  h_ratio_SR1_all->GetXaxis()->SetTitleOffset(.8);
 
  h_ratio_SR1_all->GetYaxis()->SetTitleSize(.1);
  h_ratio_SR1_all->GetYaxis()->SetTitle("Data / Pred.");
  h_ratio_SR1_all->GetXaxis()->SetTitleSize(.1);
  ...
  TPad* pad2ggfcr = new TPad("pad2ggfcr","pad2ggfcr", 0.56, 0.68, 1., 1.);
  pad2ggfcr->SetTopMargin(0.15);
  pad2ggfcr->SetBottomMargin(0.025);
  pad2ggfcr->SetLeftMargin(0.02);
  pad2ggfcr->SetRightMargin(0.15);
  pad2ggfcr->Draw();
  pad2ggfcr->cd();
  ...
  h_stack_CRGGF->GetYaxis()->SetLabelOffset(.01);
  h_stack_CRGGF->GetYaxis()->SetLabelOffset(.015);

  mytext.SetTextSize(0.05);
  subtit=obs_title(input) + " ggF CR";
  double ggf_y_title = 8250;
  if(input=="lep0_pt" || input=="lep1_pt" || input=="jet0_pt" || input=="jet1_pt") ggf_y_title = 7900;
  mytext.DrawLatex(-0.05,ggf_y_title,subtit.c_str());

  gPad->RedrawAxis();
  
  chara->cd();
  TPad* ratiopad2ggfcr = new TPad("ratiopad2ggfcr","ratiopad2ggfcr", 0.56, 0.505, 1., .68);
  ...
  h_ratio_CRGGF_all->GetYaxis()->SetLabelSize(.1);
  h_ratio_CRGGF_all->GetXaxis()->SetLabelSize(0.1);
  h_ratio_CRGGF_all->GetXaxis()->SetLabelOffset(.015);
  h_ratio_CRGGF_all->GetXaxis()->SetTitle("#it{D}_{ggF}");
  h_ratio_CRGGF_all->GetXaxis()->SetTitleSize(.1);
  h_ratio_CRGGF_all->GetXaxis()->SetTitleOffset(1.);
  h_ratio_CRGGF_all->GetYaxis()->SetLabelOffset(.015);
  ...
  padsr2->SetTopMargin(0.06);
  padsr2->SetBottomMargin(0.035);
  padsr2->SetRightMargin(0.1);
  padsr2->SetLeftMargin(0.1);
  padsr2->Draw();
  padsr2->cd();

 // gPad->SetLogy();
  h_stack_SR2_all->Draw("hist");
  h_stack_SR2_all->SetMaximum(510);
  ...
  h_stack_SR2_all->GetYaxis()->SetTitle("Events");
  h_stack_SR2_all->GetYaxis()->SetTitleSize(.055);
  h_stack_SR2_all->GetYaxis()->SetTitleOffset(0.85);
  h_stack_SR2_all->GetXaxis()->SetLabelOffset(10);
  h_stack_SR2_all->GetYaxis()->SetLabelOffset(.01);
  h_stack_SR2_all->GetYaxis()->SetLabelSize(.055);
  ...
  subtract=20;
  double minus = 3.;
  if(input=="jet0_pt" || input=="jet1_pt" ) {mult=40; subtract = -2;}
  if(input=="lep1_pt"  || input=="Ptll" ) { mult =30; subtract=-1;}
  if(input=="DYjj" ) {mult=30; subtract = -2;}
  if(input=="DPhill" || input=="DYll" || input=="pt_H" ) {mult = 30; subtract = 1;}
  if(input=="lep0_pt" || input=="SignedDPhijj"){mult = 20; subtract = -5; }
  if(input=="jet1_pt" || input=="Ptll" || input=="DYjj") minus=20;
  if(input=="Mll" || input=="DPhill" || input=="DYll" || input=="jet0_pt" || input=="lep0_pt" || input=="lep1_pt" || input=="pt_H" || input=="SignedDPhijj" ) minus=10;
  ...
  mytext.SetTextSize(.055);
  subtit="SR2";
  xstart = 3.5;
  if(input=="lep1_pt" || input=="jet0_pt" || input=="jet1_pt" || input=="pt_H" || input=="Ptll" || input=="Mll") xstart =3.;
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax(), subtit.c_str());
  subtit=obs_title(input) + " Bin1";
  xstart = -.4;
  if(input=="DPhill" || input=="DYll") xstart = -.5;
  if(input=="costhetastar") xstart = -.6;
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract),subtit.c_str());
  if(isScale2) {
  	if(input == "Mjj") mytext.DrawLatex(.05, 390,"x1");
  	if(input == "costhetastar") mytext.DrawLatex(.05, 390,"x10");
  	if(input == "DPhill") mytext.DrawLatex(.05, 230,"x2");
    if(input == "DYll") mytext.DrawLatex(.05, 245,"x2");
    if(input == "lep1_pt") mytext.DrawLatex(.05, 250,"x1");
    if(input == "jet0_pt") mytext.DrawLatex(.05, 330,"x1");
    if(input == "jet1_pt") mytext.DrawLatex(.05, 390,"x1");
    if(input == "pt_H") mytext.DrawLatex(.05, 230,"x1");
    if(input == "Ptll") mytext.DrawLatex(.05, 230,"x2");
    if(input == "Mll") mytext.DrawLatex(.05, 350,"x4");
    if(input == "lep0_pt") mytext.DrawLatex(.05, 143,"x2");
    if(input == "DYjj") mytext.DrawLatex(.05, 190,"x1");
  }
  subtit=obs_title(input) + " Bin2";
  xstart = 1.7;
  if(input=="DPhill" || input=="DYll") xstart = 1.5;
  if(input=="lep0_pt" || input=="DYjj") xstart = 1.6;
  if(input=="costhetastar") xstart = 1.3;
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract),subtit.c_str());
  if(isScale2) {
  	if(input=="Mjj") mytext.DrawLatex(2.1, 390,"x6");
  	if(input=="costhetastar") mytext.DrawLatex(2.1, 390,"x10");
  	if(input=="DPhill") mytext.DrawLatex(2.1, 230,"x2");
    if(input=="DYll") mytext.DrawLatex(2.1, 245,"x4");
    if(input=="lep1_pt") mytext.DrawLatex(2.1, 250,"x1");
    if(input=="jet0_pt") mytext.DrawLatex(2.1, 330,"x4");
    if(input=="jet1_pt") mytext.DrawLatex(2.1, 390,"x4");
    if(input=="pt_H") mytext.DrawLatex(2.1, 230,"x1");
    if(input=="Ptll") mytext.DrawLatex(2.1, 230,"x1");
    if(input=="Mll") mytext.DrawLatex(2.1, 350,"x4");
  ...
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract),subtit.c_str());
  if(isScale2) { 
	if(input=="Mjj") mytext.DrawLatex(3.9, 390,"x10");
	if(input=="costhetastar") mytext.DrawLatex(3.9, 390,"x10");
	if(input=="DPhill") mytext.DrawLatex(3.9, 230,"x2");
  if(input=="DYll") mytext.DrawLatex(3.9, 245,"x4");
  if(input=="lep1_pt") mytext.DrawLatex(3.9, 250,"x2");
  if(input=="jet0_pt") mytext.DrawLatex(3.9, 330,"x6");
  if(input=="jet1_pt") mytext.DrawLatex(3.9, 390,"x6");
  if(input=="pt_H") mytext.DrawLatex(3.9, 230,"x2");
  if(input=="Ptll") mytext.DrawLatex(3.9, 230,"x1");
  if(input=="Mll") mytext.DrawLatex(3.9, 350,"x4");
  ...
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract),subtit.c_str());
  if(isScale2) {
  	if(input=="Mjj") mytext.DrawLatex(5.9, 390,"x14");
  	if(input=="costhetastar") mytext.DrawLatex(5.9, 390,"x10");
  	if(input=="DPhill") mytext.DrawLatex(5.9, 230,"x2");
    if(input=="DYll") mytext.DrawLatex(5.9, 245,"x4");
    if(input=="lep1_pt") mytext.DrawLatex(5.9, 250,"x2");
    if(input=="jet0_pt") mytext.DrawLatex(5.9, 330,"x6");
    if(input=="jet1_pt") mytext.DrawLatex(5.9, 390,"x6");
    if(input=="pt_H") mytext.DrawLatex(5.9, 230,"x8");
    if(input=="Ptll") mytext.DrawLatex(5.9, 230,"x2");
    if(input=="Mll") mytext.DrawLatex(5.9, 350,"x1");
    if(input=="lep0_pt") mytext.DrawLatex(5.9, 143,"x1");
    if(input=="DYjj") mytext.DrawLatex(5.9, 190,"x2");
  }
  subtit=obs_title(input) + " Bin5";
  xstart = 7.5;
  if(input=="DPhill" || input=="DYll" || input=="DYjj") xstart = 7.3;
  if(input=="lep0_pt" || input=="costhetastar") xstart = 7.2;
  mytext.DrawLatex(xstart, gPad->GetUymax() - mult*(gPad->GetUymax()-mult)/gPad->GetUymax() - (mult-subtract),subtit.c_str());
  if(isScale2) {
  	if(input=="Mjj") mytext.DrawLatex(7.9, 390,"x40");
  	if(input=="costhetastar") mytext.DrawLatex(7.9, 390,"x1");
  ...
  h_ratio_SR2_all->GetYaxis()->SetLabelSize(.09);
  h_ratio_SR2_all->GetXaxis()->SetLabelSize(.09);
 // h_ratio_SR1->GetYaxis()->SetLabelOffset(.01);
 // h_ratio_SR1_all->GetXaxis()->SetLabelOffset(1.);
  ...
  h_ratio_SR2_all->GetYaxis()->SetTitleOffset(.48);
  h_ratio_SR2_all->GetXaxis()->SetTitleOffset(.8);
 
  h_ratio_SR2_all->GetYaxis()->SetTitleSize(.09);
  h_ratio_SR2_all->GetYaxis()->SetTitle("Data / Pred.");
  h_ratio_SR2_all->GetXaxis()->SetTitleSize(.1);
  ...
  if(input=="jet1_pt"){
   ...
   mytext.SetTextSize(.09);
   mytext.DrawLatex(-1, .35, "-1.0");
   mytext.DrawLatex(1., .35, "-1.0");
   mytext.DrawLatex(3., .35, "-1.0");
   mytext.DrawLatex(5., .35, "-1.0");
   if( (input=="Mjj" || input=="lep0_pt" || input=="costhetastar" || input=="DPhill" || input=="DYll" ) )  mytext.DrawLatex(7., .35, "-1.0");
   
   mytext.DrawLatex(0.8, 1.44, "1.0");
   mytext.DrawLatex(2.8, 1.44, "1.0");
   mytext.DrawLatex(4.8, 1.44, "1.0");
   mytext.DrawLatex(6.8, 1.44, "1.0");
   mytext.DrawLatex(8.8, 1.44, "1.0");
 }
  ...
  TPad* pad4dycr = new TPad("pad4dycr", "pad4dycr", .56, 0.2, 1., .5);

  pad4dycr->SetTopMargin(0.015);
  pad4dycr->SetBottomMargin(0.035);
  pad4dycr->SetLeftMargin(0.02);
  pad4dycr->SetRightMargin(.15);
  ...
  h_stack_DYCR->GetYaxis()->SetLabelOffset(.02);
  h_stack_DYCR->GetYaxis()->SetLabelSize(.055);

  mytext.SetTextSize(.055);

  double zjets_y_title = 240.5;
  if(input=="lep0_pt" || input=="lep1_pt" || input=="jet0_pt" || input=="jet1_pt") zjets_y_title = 232.5;
  subtit=obs_title(input) + " Z+jets CR";
  mytext.DrawLatex(92,zjets_y_title,subtit.c_str());

  TLegend* legendggfcr = new TLegend(0.4,0.48,.81,0.81);
  legendggfcr->SetBorderSize(0);
  legendggfcr->SetFillStyle(0);
  legendggfcr->SetTextSize(0.);
  legendggfcr->SetNColumns(2);
  legendggfcr->AddEntry(h_data_CRGGF, "#bf{Data}", "pe");
  ...
  chara->cd();
  TPad* ratiopad4dycr = new TPad("ratiopad4dycr","ratiopad4dycr", .56, 0.0025, 1., .2);

  ratiopad4dycr->SetLeftMargin(0.02);
  ratiopad4dycr->SetRightMargin(0.15);
  ...
  h_ratio_DYCR_all->GetYaxis()->SetLabelSize(.09);
  h_ratio_DYCR_all->GetXaxis()->SetLabelSize(.09);
  h_ratio_DYCR_all->GetYaxis()->SetLabelOffset(.02);
  ...
  h_ratio_DYCR_all->GetXaxis()->SetTitleSize(.09);
  ...
  atlastex.DrawLatex(0.06, 0.96, "#it{#bf{#scale[1.2]{ATLAS}}}  Internal");
